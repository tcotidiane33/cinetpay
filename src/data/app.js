...
//      // Ajoutez un identifiant unique à chaque livre
//      bookCard.setAttribute('data-toggle', 'modal');
//      bookCard.setAttribute('data-target', `#modal${book.id}`); // Utilisez un identifiant unique pour chaque livre 
...
//     const openModalButton = document.createElement('button');
//     openModalButton.setAttribute('type', 'button');
//     openModalButton.classList.add('btn', 'btn-primary');
//     openModalButton.setAttribute('data-bs-toggle', 'modal');
//     openModalButton.setAttribute('data-bs-target', `#modal${book.id}`);
